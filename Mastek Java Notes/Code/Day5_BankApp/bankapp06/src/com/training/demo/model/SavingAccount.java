...
public class SavingAccount extends BankAccount {
	...
	public String withdraw(double amount) {
		...
		if (diffBalance >= MIN_BALANCE) {
			...
			return this.getAccNo() + " debited with " + amount + ".Current balnace is :" + this.getBalance();
		}
		return "Enter some other amount to ensure minmum balance is "
				+ "availalbe in the account";
	}
